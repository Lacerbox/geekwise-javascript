...
var Deck = (function () {
    ...
    Deck.prototype.createCardPicker = function () {
        ...
        return function () {
            ...
            console.log(_this.cardsPicked); // that have been picked keeping a running total of cards picked
            console.log(card);
            ...
            console.log(card);
            console.log(cardsRemainingInDeck - 2 + ' CARDS REMAINING IN DECK');
            ...
            if (cardPicked1 === 'Te' && cardPicked2 === 'Ac' || cardPicked1 === 'Ja' && cardPicked2 === 'Ac' ||
                ...
                console.log('BLACKJACK!!! | Card 1 = ' + card1 + ' & Card 2 = ' + card2 + ' | BLACKJACK!!!');
            }
