// THE FOLLOWING WAS THOUGHT TO PREVENT THE SAME CARDS FROM BEING PICKED:
    ...
    Deck.prototype.createCardPicker = function () {
        ...
        return function () {
            ...
            //function cardChecking() {
              ...
              for (let i = 0; i < cardsCheck.length; i++) {
                //console.log("BEFORE 1ST IF ************************* BEFORE 1ST IF: " + cardsCheck[i] + " | " + newCardRankSuit);
                if (cardsCheck[i] === newCardRankSuit) {
                  console.log("IN 1ST IF ************************* IN 1ST IF: " + cardsCheck[i] + " | " + newCardRankSuit);
                  suit = _this.cardSuits[Math.floor(Math.random() * _this.cardSuits.length)];
                  rank = _this.cardRanks[Math.floor(Math.random() * _this.cardRanks.length)];
                  console.log(rank + ' OF ' + suit);
                  ...
                  for (let i = 0; i < cardsCheck.length; i++) {
                    if (cardsCheck[i] === _newCardRankSuit) {
                      console.log("IN 2ND IF ************************* IN 2ND IF: " + cardsCheck[i] + " | " + _newCardRankSuit);
                      suit = _this.cardSuits[Math.floor(Math.random() * _this.cardSuits.length)];
                      rank = _this.cardRanks[Math.floor(Math.random() * _this.cardRanks.length)];
                      console.log(rank + ' OF ' + suit);
                      ...
                      for (let i = 0; i < cardsCheck.length; i++) {
                        if (cardsCheck[i] === __newCardRankSuit) {
                          console.log("IN 3RD IF ************************* IN 3RD IF: " + cardsCheck[i] + " | " + __newCardRankSuit);
                          suit = _this.cardSuits[Math.floor(Math.random() * _this.cardSuits.length)];
                          rank = _this.cardRanks[Math.floor(Math.random() * _this.cardRanks.length)];
                          console.log(rank + ' OF ' + suit);
                          ...
                          for (let i = 0; i < cardsCheck.length; i++) {
                            if (cardsCheck[i] === ___newCardRankSuit) {
                              console.log("IN 4TH IF ************************* IN 4TH IF: " + cardsCheck[i] + " | " + ___newCardRankSuit);
                              suit = _this.cardSuits[Math.floor(Math.random() * _this.cardSuits.length)];
                              rank = _this.cardRanks[Math.floor(Math.random() * _this.cardRanks.length)];
                              console.log(rank + ' OF ' + suit);
                              ...
                              for (let i = 0; i < cardsCheck.length; i++) {
                                if (cardsCheck[i] === ____newCardRankSuit) {
                                  console.log("IN 5TH IF ************************* IN 5TH IF: " + cardsCheck[i] + " | " + ____newCardRankSuit);
                                  suit = _this.cardSuits[Math.floor(Math.random() * _this.cardSuits.length)];
                                  rank = _this.cardRanks[Math.floor(Math.random() * _this.cardRanks.length)];
                                  console.log(rank + ' OF ' + suit);
                                }
