// TAKEN FROM 'http://javascriptissexy.com/understand-javascripts-this-with-clarity-and-master-it/'
...
var person = {
  ...
  fullName: function () {
    ...
    console.log(this.firstName + " " + this.lastName); // Logs "Penelope Barrymore"
    // We could have also written this:
    console.log(person.firstName + " " + person.lastName); // Logs "Penelope Barrymore"
  }
};
person.fullName();
